...
| Path | Purpose | Status |
|---|---|---|
| `evaluation/` | DeepEval-based evaluation harness — runs the agent end-to-end, measures retrieval and answer quality with 13 metrics, persists results to SQLite, and provides a Streamlit dashboard. See [`evaluation/README.md`](evaluation/README.md) for full details | Learning/Demo |
...
| `evaluation/` | Subfolder | DeepEval evaluation harness, SQLite ledger, Streamlit dashboard, and test cases |
...
7. Read `evaluation/README.md` and run the evaluation harness to measure agent quality.
